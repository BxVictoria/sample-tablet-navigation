package ru.dialog.tabletfragmentnavigation.slidr.util;
...
import ru.dialog.tabletfragmentnavigation.slidr.model.SlidrPosition;
...
public class ViewHelper {
    ...
    private static View findScrollableViewContains(View mView, SlidrPosition direction, int x, int y) {
        ...
        for (int i = 0; i < mViewGroup.getChildCount(); i++) {
            ...
            if (childView.getVisibility() != View.VISIBLE || !isViewUnder(childView, relativeX, relativeY))
                continue;
